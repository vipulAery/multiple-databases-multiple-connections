...
public class Book extends TableImpl<BookRecord> {
    ...
    private static final long serialVersionUID = 199879187;
     ...
     */
    public final TableField<BookRecord, String> CONTENT_PDF = createField(DSL.name("content_pdf"), org.jooq.impl.SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<BookRecord, Timestamp> REC_TIMESTAMP = createField(DSL.name("rec_timestamp"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PK_T_BOOK);
    }
    ...
    public List<ForeignKey<BookRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<BookRecord, ?>>asList(Keys.BOOK__FK_T_BOOK_AUTHOR_ID, Keys.BOOK__FK_T_BOOK_CO_AUTHOR_ID);
    }

    public Author book_FkTBookAuthorId() {
        return new Author(this, Keys.BOOK__FK_T_BOOK_AUTHOR_ID);
    }

    public Author book_FkTBookCoAuthorId() {
        return new Author(this, Keys.BOOK__FK_T_BOOK_CO_AUTHOR_ID);
    }
